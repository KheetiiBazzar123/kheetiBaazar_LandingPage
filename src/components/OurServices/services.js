  ...
  return (
    <Box p={3}>
      ...
      <Typography variant="body1" color="textSecondary" gutterBottom>
        Jaipur Golden is a leading provider of specialized service in integrated multi-mode solutions for the transportations of bulk of container cargo. Jaipur Golden provides a single window for businesses that seek seamless transportation, warehousing, supply chain management and trucking.
      </Typography>
